            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown user-box">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                        ...
                        <li><a href="{{ url('company/profile') }}"><i class="ti-user m-r-5"></i> Profile</a></li>
...
<div class="left side-menu">
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                <li>
                    <a href="{{  url('company/home') }}" class="waves-effect"><i class="mdi mdi-view-dashboard"></i><span>Dashboard</span></a>
                </li>
                <li>
                    <a href="{{  route('employee.index') }}" class="waves-effect"><i class="fa fa-users"></i><span>Employee</span></a>
                </li>
		<li>
		   <a href="{{ url('company/companysms') }}" class="waves-effect"> <i class="fa fa-comments"></i>SMS</a>
		</li>
            </ul>
        </div>
    </div>
