    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="page-title-box">
            ...
            <h4 class="page-title">Edit SMS</h4>
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          ...
          <div class="card-box">
            ...
            {!! Form::model($row, ['method'=>'patch','files'=>true,'route' => ['sms.update', $row->id]]) !!}
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" name="firstname" value="{{ old('name',$row->firstname) }}" class="form-control" required="">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" name="lastname" value="{{ old('name',$row->lastname) }}" class="form-control" required="">
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="email" name="email" id="email" value="{{ old('email',$row->email)}}" class="form-control" required="">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control number" name="wphone" required="" minlength="10" maxlength="10" value="{{ old('phone',$row->wphone) }}">
              ...
              <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control number" name="hphone" required="" minlength="10" maxlength="10" value="{{ old('phone',$row->hphone) }}">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" name="address" value="{{ old('address',$row->address) }}" class="form-control" required="">
		...
		<div class="row form-group">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" class="form-control number" name="zipcode" required=""  value="{{ old('zipcode',$row->zipcode) }}">
	 ...
	 <div class="row form-group">
                ...
                <div class="col-sm-12">
                  ...
                  <input type="text" name="state" value="{{ old('state',$row->state) }}" class="form-control" required="">
